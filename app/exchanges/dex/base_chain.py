...
def build_base_mock_adapters(settings: Settings) -> dict[str, MockV3Adapter]:
    uni_pool = PoolModel(
        ...
        quoter_fee_tier=100,
        pool_fee_tier=100,
        configured_economic_fee_bps=100,
...
def build_base_real_adapters(settings: Settings) -> dict[str, RealV3LikeAdapter]:
    uni_pool = PoolModel(
        pool_id="base_uni_v3_virtual_usdc_100",
        quoter_fee_tier=settings.base_uniswap_quoter_fee_tier,
        pool_fee_tier=settings.base_uniswap_pool_fee_tier,
        configured_economic_fee_bps=settings.base_uniswap_economic_fee_bps,
        mid_price=Decimal("0"),
    ...
    cake_pool = PoolModel(
        pool_id="base_cake_v3_virtual_usdc_100",
        quoter_fee_tier=settings.base_pancake_quoter_fee_tier,
        pool_fee_tier=settings.base_pancake_pool_fee_tier,
        configured_economic_fee_bps=settings.base_pancake_economic_fee_bps,
        mid_price=Decimal("0"),
        liquidity_usd=Decimal("0"),
    ...
    aero_pool = PoolModel(
        pool_id="base_aero_virtual_usdc_100",
        quoter_fee_tier=settings.base_aerodrome_quoter_fee_tier,
        pool_fee_tier=settings.base_aerodrome_pool_fee_tier,
        configured_economic_fee_bps=settings.base_aerodrome_economic_fee_bps,
        mid_price=Decimal("0"),
        liquidity_usd=Decimal("0"),
